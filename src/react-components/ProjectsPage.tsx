...
export function ProjectsPage(props: Props) {
    ...
    const onNewProjectClick = () => {
        ...
        if (
            !(newProjectModal && newProjectModal instanceof HTMLDialogElement)
        ) {
            return;
        } else {
    ...
    const onNewProjectFormSubmit = (e: React.FormEvent) => {
        ...
        const newProjectModal = document.getElementById(
            'new-project-modal'
    ...
    return (
        ...
        >
            <ProjectForm
                ...
                onSubmit={onNewProjectFormSubmit}
            ></ProjectForm>

            <header className="page-header">
                <h2>Projects</h2>
                <SearchBox
                    onChange={(value) => onProjectSearch(value)}
